...
/**
 * Controlador de la Pantalla Configuració
...
public class Controlador_Configuracio {
    ...
    /**
     * Construeix el Controlador Configuració amb:
     * @param confScreen la Pantalla Configuració
     * @param menjadoraDreta i les dues Menjadores
    ...
    //METODES
    /**
     * Afegeix un Controlador Configuració amb:
     * @param confScreen la Pantalla Configuració
     * @param menjadoraDreta i les dues Menjadores
     * @param menjadoraEsquerra
     * @return un nou Controlado Configuració
     */
     ...
     * @param dreta booleà Menjadora dreta o esquerra
     * @param raccioExtra grams racció extra [integer]
     */
